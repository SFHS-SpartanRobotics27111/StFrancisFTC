...
public class PinpointDrive extends MecanumDrive {
    ...
    public static class Params {
        ...
        public double xOffset = 6.5; //13 old number - remeasured with pythagrean theorem, 10.1 calculated, further testing required
        //
        public double yOffset = 6.5; //6.75 oriiginal
