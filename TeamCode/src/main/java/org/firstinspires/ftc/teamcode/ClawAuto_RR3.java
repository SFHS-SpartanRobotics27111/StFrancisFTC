...
@Autonomous(name = "2 Specimen on High Chamber: Marked for Deletion", group = "Linear OpMode")
public final class ClawAuto_RR3 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action splineToPush = drive
                ...
                .splineTo(new Vector2d(43, -13), 1.5)
